...
def evaluate_by_category(predictions,
                         ...
                         diagnostics_file_original="/home/b/bharanibala/noisefind/carto/exe1/diagnostics_nli/diagnostic-full.tsv"):
...
if __name__ == "__main__":
  ...
  parser.add_argument("--diagnostics_input",
                      ...
                      default="/home/b/bharanibala/noisefind/carto/exe1/diagnostic_nli/diagnostic-full.tsv")
  parser.add_argument("--output",
                      "-o",
                      type=os.path.abspath,
                      default="/home/b/bharanibala/noisefind/carto/exe1/data/glue/SNLI/diagnostics_test_bugfree.tsv")
